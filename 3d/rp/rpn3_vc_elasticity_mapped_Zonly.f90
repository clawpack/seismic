...
! material properties and mapping in z direction only
!
! waves: 6
! equations: 9
! aux fields: 12
...
!       4 cp
!       5 cs
!       6 area ratio of lower wall in x-direction
!       7 area ratio of lower wall in y-direction
!       8 nx at lower wall in z-direction
!       9 ny at lower wall in z-direction
!       10 nz at lower wall in z-direction
!       11 area ratio of lower wall in z-direction
!       12 capacity function value
...
!     # find a1-a6, the coefficients of the 6 eigenvectors:
    do i = 2-mbc, mx+mbc
        ...
        if (det < 1.e-10) then
            ...
            if (ixyz == 1) then
                a1 = (cpr*dsig_xx + bulkr*du) / det
                a2 = (cpl*dsig_xx - bulkl*du) / det

                wave(sig_xx,1,i) = a1 * bulkl
                wave(sig_yy,1,i) = a1 * laml
                wave(sig_zz,1,i) = a1 * laml
                wave(u,1,i) = a1 * cpl

                wave(sig_xx,2,i) = a2 * bulkr
