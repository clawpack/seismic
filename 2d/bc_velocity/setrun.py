...
#------------------------------
    ...
    probdata.add_param('rho2',     2.0,  'density in middle layer')
    ...
    for gaugeno,x in enumerate(np.linspace(0.1,1.9,100)):
        gauges.append([gaugeno,x,0.199,0,1e10])
    # bottom edge:
    for gaugeno,x in enumerate(np.linspace(0.1,1.9,100)):
    ...
    regions.append([4,4,0,0.2,.9,1.1,0.,0.2])
